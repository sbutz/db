----------------------------------------------------------
-- Installation der BIKE-Datenbank fuer Oracle
--
--        zum Starten unter SQL Developer
--                          Edwin Schicker, Maerz 2019
----------------------------------------------------------
--
-- Hinweise zur Installation auf dem eigenen Rechner 
--      gilt nur für Oracle 18c Express Edition !!!!
--
-- 1. Starten Sie Oracle SQL Developer.
--    Erzeugen Sie eine neue Verbindung (links auf '+' klicken) mit folgenden
--    Admin-Daten: 
--
--      Verbindungsname: OracleXEAdmin     (im Prinzip frei wählbar)
--      Benutzername:    sys as sysdba
--      Kennwort:        Admin-Passwort    (wurde bei Installation angefordert!!)
--      Verbindungstyp:  Einfach
--      Rolle:           SYSDBA            (!!!!)
--      Hostname:        localhost         (vorgegeben)
--      Port:            1521              (vorgegeben)
--      Servicename:     xepdb1            (bedeutet: XE Pluggable Database 1)
--
--    Testen Sie diese Verbindung. Bei Erfolg klicken Sie auf SPEICHERN
--
-- 2. Starten Sie diese Admin-Verbindung und erzeugen eine neue
--    Standardbenutzerkennung mit folgenden Befehlen (PASSWORT frei wählbar):
--
--    Create User BIKE Identified By PASSWORT;            (eigenes Passwort angeben!!!)
--    Grant Connect, Resource, Create View, Unlimited Tablespace To BIKE;       (alle Zugriffsrechte setzen, die wir brauchen)
--
-- 3. Öffnen Sie nun eine weitere Verbindung (auf '+' klicken) mit folgenden Daten:
--
--      Verbindungsname: OracleXEBike       (im Prinzip frei wählbar)
--      Benutzername:    bike
--      Kennwort:        (obiges definiertes PASSWORT)
--      Verbindungstyp:  Einfach
--      Rolle:           Standard           (!!!!)
--      Hostname:        localhost          (vorgegeben)
--      Port:            1521               (vorgegeben)
--      Servicename:     xepdb1
--
-- 4. Starten Sie jetzt diese Verbindung.
--
-- 5. Öffnen Sie das Skript "bikeOracle.sql" aus Moodle
--
-- 6. Starten Sie das Skript (einfach F5 klicken!)
--    Unter Verbindung wählen Sie bike aus.
--
-- Ende der Hinweise zur Installation von Oracle XE auf dem eigenen Rechner

-- Einstellungen im eigenen SQL Developer, um auf ORA12C auf dem Server FBIM zuzugreifen:
--    Zum Zugriff wird VPN benötigt, wenn man sich nicht auf dem OTH Gelände befindet
--
--      Verbindungsname: Bike           (oder jeder beliebige andere Name)
--      Benutzername:    abc12345       (Ihre NDS-Kennung)
--      Kennwort:        abc12345       (Ihre NDS-Kennung, nicht das Passwort)
--      Verbindungstyp:  Einfach
--      Rolle:           Standard      (!!!!)
--      Hostname:        zeus.oth-regensburg.de
--      Port:            1522          (Achtung, nicht 1521)
--      SID:             ora12c        (hier die SID verwenden, nicht den Servicename)
--
-- Ende der Hinweise zu SQL Developer zum Zugriff auf ORA12C

SET TERMOUT ON
PROMPT Installation der BIKE-Datenbank. Bitte etwas Geduld
SET TERMOUT OFF
SET FEEDBACK OFF
PROMPT
...
PROMPT Installation der Beispieldatenbank BIKE ist abgeschlossen
